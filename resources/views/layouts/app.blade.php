...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased text-gray-900 dark:text-gray-100">
        ...
        {{-- CONTENEDOR FLEX PRINCIPAL (Fija la altura a la pantalla) --}}
        <div class="flex h-screen overflow-hidden bg-gradient-to-br from-gray-50 via-slate-50 to-gray-100 dark:from-gray-900 dark:via-slate-900 dark:to-gray-800">
            
            {{-- Elementos decorativos de fondo sutiles (Se mantienen en la capa base z-0) --}}
            ...
            {{-- 1. BARRA LATERAL (Fija a la izquierda, en una capa superior z-20) --}}
            <div class="relative z-20 flex-shrink-0 bg-white dark:bg-gray-900 shadow-xl">
                @include('layouts.sidebar')
            </div>

            {{-- 2. ÁREA DE CONTENIDO PRINCIPAL (Hace scroll independiente) --}}
            <div class="relative z-10 flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
                
                {{-- Page Heading --}}
                @isset($header)
                    <header class="sticky top-0 z-30 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md shadow-sm border-b border-gray-200 dark:border-gray-700">
