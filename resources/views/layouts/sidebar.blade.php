<div x-data="{ sidebarOpen: true }" class="relative">
    ...
    <button 
        ...
        class="fixed top-4 left-4 z-50 bg-slate-800 hover:bg-slate-700 text-white p-2.5 rounded-lg shadow-lg transition-all duration-300 border border-slate-600"
        :class="{ 'left-64': sidebarOpen, 'left-4': !sidebarOpen }"
    ...
    <aside 
        ...
        class="fixed left-0 top-0 flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-slate-900 border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 z-40">
