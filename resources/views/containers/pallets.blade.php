    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-3">
                ...
                <div><h2 class="font-bold text-2xl text-gray-800 dark:text-gray-100">Armado de Tarimas</h2><p class="text-sm text-gray-600 dark:text-gray-400 mt-1">{{ $container->container_number }}</p></div>
            </div>
